...
public class FindTheDistanceValueBetweenTwoArrays {
    ...
    public static void main(String[] args) {
        FindTheDistanceValueBetweenTwoArrays fd = new FindTheDistanceValueBetweenTwoArrays();
        System.out.println(fd.findTheDistanceValue(new int[]{4,5,8},new int[]{10,9,1,8},2));
    }
